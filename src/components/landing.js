...
const init = async () => {
	try {
		...
		await page.waitForSelector(
			`.nav-search-classi >.nav-search-classi-content >.ch-popover-wrapper input`,
		);
		await page.type(
			`.nav-search-classi > .nav-search-classi-content > .ch-popover-wrapper input`,
			" Bogotá D.C.",
		...
		await page.waitForSelector(
			`.nav-search-classi > .nav-search-classi-content > .ch-popover-wrapper > .ch-popover > ul > .ch-autocomplete-item`,
		);
